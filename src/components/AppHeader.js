...
import { headerNavMenus, publicLinks } from "@/lib/app.config";
import AuthButtons from "./Auth/AuthButtons/AuthButton";

export default async function AppHeader() {
	const session = await auth();
	return (
		<header className="sticky top-0 flex h-16 items-center gap-4 border-b border-primary-gray bg-primary px-4 md:px-6 z-[999]">
